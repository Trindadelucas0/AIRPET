...
router.get('/agendamentos-recebidos', petshopPanelController.mostrarAgendamentosRecebidos);
router.get('/servicos', petshopPanelController.mostrarServicos);
router.get('/perfil', petshopPanelController.mostrarPerfilPublico);
router.get('/pets-vinculados', petshopPanelController.mostrarPetsVinculados);
